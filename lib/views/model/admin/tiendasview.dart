...
class TiendasView extends StatefulWidget {
  const TiendasView({super.key});

  @override
  State<TiendasView> createState() => _TiendasViewState();
}

class _TiendasViewState extends State<TiendasView> {
  @override
